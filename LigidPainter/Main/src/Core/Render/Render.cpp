...
ColorPicker &colorPicker,TextureDisplayer &textureDisplayer,Cubemaps cubemaps,ContextMenu &addNodeContextMenu,NodePanel &nodePanel,std::vector<Node> &nodes) {
	GlSet gls;
	ColorData colorData;
	Utilities util;
	...
	uiOut = renderUi(panelData, renderData, FBOScreen,icons
		...
		colorPicker,textureDisplayer,addNodeContextMenu,nodePanel,nodes);
