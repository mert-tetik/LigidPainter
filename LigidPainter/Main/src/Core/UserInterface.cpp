...
int UserInterface::messageBox(GLFWwindow* window, double mouseXpos,double mouseYpos,LigidCursors cursors,Icons icons){
	UserInterface ui;
	ColorData colorData;
	int result = 2;

	//Panel
	ui.box(0.00f, 0.04f, -0.25f, -0.25f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 7, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.00f, 0.04f, 0.25f, -0.25f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 7, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.00f, 0.04f, -0.25f, 0.25f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 7, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.00f, 0.04f, 0.25f, 0.25f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 7, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.25f, 0.25f, 0.0f, 0.0f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 10000, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.25f, 0.05f, 0.0f, -0.24f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 10000, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.25f, 0.05f, 0.0f, +0.24f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 10000, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.03f, 0.25f, -0.242f, 0.0f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 10000, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.03f, 0.25f, +0.242f, 0.0f, "", colorData.buttonColor, 0.022f, false, false, 0.9f, 10000, colorData.buttonColorHover, 0);//Load model button
				
	//Buttons
	ui.box(0.04f, 0.04f, -0.1f, -0.15f, "Yes", colorData.buttonColor, 0.015f, false, false, 0.95f, 10, colorData.buttonColorHover, 0);//Load model button
	ui.box(0.04f, 0.04f, +0.1f, -0.15f, "No", colorData.buttonColor, 0.012f, false, false, 0.95f, 10, colorData.buttonColorHover, 0);//Load model button

	bool resultYesHover = ui.isMouseOnButton(window, 0.06f, 0.04f, -0.1, -0.15f, mouseXpos, mouseYpos, false);//Yes button hover
	bool resultNoHover = ui.isMouseOnButton(window, 0.06f, 0.04f, +0.1, -0.15f, mouseXpos, mouseYpos, false);//No button hover
	...
	if(resultYesHover || resultNoHover){
		glfwSetCursor(window,cursors.pointerCursor);//Set pointer cursor once cursor enters any of the buttons
	}
	else{
		glfwSetCursor(window,cursors.defaultCursor);//Set pointer cursor once cursor enters any of the buttons
	}
