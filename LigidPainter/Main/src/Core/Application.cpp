...
bool LigidPainter::run()
{
	...
	renderer.startScreenLoadAProjectButton = RendererButton(0.15f,0.06f,40,0,"Load",glm::vec4(0.f,0.f,0.f,1.f),glm::vec4(colorData.LigidPainterThemeColor,1),0,window);
