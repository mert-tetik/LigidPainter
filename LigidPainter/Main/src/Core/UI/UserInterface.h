...
#define UIpaintOverPosXRangeBarElement 53
#define UIpaintOverPosYRangeBarElement 54
#define UIpaintOverScaleXRangeBarElement 55
#define UIpaintOverScaleYRangeBarElement 56
#define UIpaintOverScaleTextElement 57
#define UIpaintOverPosTextElement 58
#define UIpaintOverXTextElement 59
#define UIpaintOverYTextElement 60
#define UIdynamicPaintingCheckBoxElement 61
#define UIdynamicPaintingIconElement 62
#define UImaskPaintingCheckBoxElement 63
#define UImaskPaintingIconElement 64
#define UIcolorPaintingCheckBoxElement 65
#define UIcolorPaintingIconElement 66
#define UInormalmapPaintingCheckBoxElement 67
#define UInormalPaintingIconElement 68
#define UIsubSelectedImagePowerRangeBarElement 69
#define UIsubSelectedImagePowerRangeBarTextElement 70
#define UIfocusModeCheckBox 71
#define UImirrorXRangeBarElement 72
#define UImirrorYRangeBarElement 73
#define UImirrorZRangeBarElement 74
#define UIalbedoChannelCheckBoxElement 75
#define UIroughnessChannelCheckBoxElement 76
#define UImetallicChannelCheckBoxElement 77
#define UInormalChannelCheckBoxElement 78
#define UIjpgIcon 79
#define UIpngIcon 80
#define UIfolderIcon 81
#define UIloadPlaneModelButton 82
#define UIloadSphereModelButton 83
#define UIplaneIcon 84
...
struct ColorData //LigidPainter color palette
{
	...
	glm::vec4 mainPanelSliderColor = glm::vec4(0.13f, 0.13f, 0.13f,0.5f);
};
...
public:
	...
	void sndPanel(int state,float panelLoc , Programs programs , Icons icons , std::vector<aTexture> &albedoTextures,GLFWwindow* window,double mouseXpos,
					double mouseYpos,float screenGapX,float maxScreenWidth,int& selectedAlbedoTextureIndex,std::vector<NodeScene>& nodeScenes,int &selectedNodeScene,
					...
					bool& anyTextureNameActive,std::string &textureText,int& folderIndex,NodePanel &nodePanel,std::vector<Node> appNodes,SndPanel &sndpnl,
					BrushTexture &brushMaskTextures,bool maskPanelEnter,float yOffset,std::vector<NodeScene> &nodeScenesHistory,int brushMaskTexturesState,
					int chosenTextureResIndex,bool &textureDraggingState);
	...
	void spinnerBox(float width, float height, float position_x, float position_y,float z, float &value,float xOffset,float yOffset, double mouseXpos,double mouseYpos ,GLFWwindow* window);
