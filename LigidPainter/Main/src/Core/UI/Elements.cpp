...
UI UserInterface::getUiElements(Icons icons) {
    ...
    uploadingModelPathTextBox.textBox.panel = 1;
    uploadingModelPathTextBox.textBox.attachedToMainPanel = true;
    ...
    uploadingModelPathText.text.panel = 1;
    uploadingModelPathText.text.attachedToMainPanel = true;
    ...
    loadModelButton.button.positionY = 0.9f;
    ...
    loadModelButton.button.panel = 1;
    loadModelButton.button.attachedToMainPanel = true;
    ...
    autoTriangulateCheckBox.checkBox.panel = 1;
    autoTriangulateCheckBox.checkBox.attachedToMainPanel = true;
    ...
    backfaceCullingCheckBox.checkBox.panel = 1;
    backfaceCullingCheckBox.checkBox.attachedToMainPanel = true;
    ...
    modelPanel3DModelsText.text.panel = 1;
    modelPanel3DModelsText.text.attachedToMainPanel = true;
    ...
    loadPlaneModelButton.button.buttonCurveReduce = 6.0f;
    loadPlaneModelButton.button.text = "";
    loadPlaneModelButton.button.textRatio = 0.022f;
    loadPlaneModelButton.button.panel = 1;
    loadPlaneModelButton.button.attachedToMainPanel = true;
    ...
    loadSphereModelButton.button.buttonCurveReduce = 6.0f;
    loadSphereModelButton.button.text = "";
    loadSphereModelButton.button.textRatio = 0.022f;
    loadSphereModelButton.button.panel = 1;
    loadSphereModelButton.button.attachedToMainPanel = true;
    ...
    loadCustomModelButton.button.panel = 1;
    loadCustomModelButton.button.attachedToMainPanel = true;
    ...
    addBrushMaskTextureButton.button.panel = 3;
    addBrushMaskTextureButton.button.attachedToMainPanel = true;
    ...
    useNegativeCheckBox.checkBox.panel = 3;
    useNegativeCheckBox.checkBox.attachedToMainPanel = true;
    ...
    maskTextureFileNameText.text.panel = 3;
    maskTextureFileNameText.text.attachedToMainPanel = true;
    ...
    brushSizeText.text.panel = 3;
    brushSizeText.text.attachedToMainPanel = true;
	...
	brushSizeRangeBar.rangeBar.panel = 3;
	brushSizeRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    brushBlurText.text.panel = 3;
    brushBlurText.text.attachedToMainPanel = true;
	...
	brushBlurRangeBar.rangeBar.value = 0.0f;
	brushBlurRangeBar.rangeBar.panel = 3;
	brushBlurRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    brushRotationText.text.panel = 3;
    brushRotationText.text.attachedToMainPanel = true;
	...
	brushRotationRangeBar.rangeBar.value = 0.0f;
	brushRotationRangeBar.rangeBar.panel = 3;
	brushRotationRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    brushOpacityText.text.panel = 3;
    brushOpacityText.text.attachedToMainPanel = true;
	...
	brushOpacityRangeBar.rangeBar.value = 0.0f;
	brushOpacityRangeBar.rangeBar.panel = 3;
	brushOpacityRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    brushSpacingText.text.panel = 3;
    brushSpacingText.text.attachedToMainPanel = true;
	...
	brushSpacingRangeBar.rangeBar.value = 0.0f;
	brushSpacingRangeBar.rangeBar.panel = 3;
	brushSpacingRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    brushBordersText.text.panel = 3;
    brushBordersText.text.attachedToMainPanel = true;
	...
	brushBordersRangeBar.rangeBar.value = 0.0f;
	brushBordersRangeBar.rangeBar.panel = 3;
	brushBordersRangeBar.rangeBar.attachedToMainPanel = true;
    ...
    mirrorXCheckBox.checkBox.panel = 3;
    mirrorXCheckBox.checkBox.attachedToMainPanel = false;
    ...
    mirrorYCheckBox.checkBox.panel = 3;
    mirrorYCheckBox.checkBox.attachedToMainPanel = false;
    ...
    mirrorZCheckBox.checkBox.panel = 3;
    mirrorZCheckBox.checkBox.attachedToMainPanel = false;
    ...
    exportingPathTextBox.textBox.text = "";
    exportingPathTextBox.textBox.panel = 4;
    exportingPathTextBox.textBox.attachedToMainPanel = true;
    ...
    exportingFolderNameTextBox.textBox.text = "";
    exportingFolderNameTextBox.textBox.panel = 4;
    exportingFolderNameTextBox.textBox.attachedToMainPanel = true;
    ...
    jpgCheckBox.checkBox.panel = 4;
    jpgCheckBox.checkBox.attachedToMainPanel = true;
    ...
    pngCheckBox.checkBox.panel = 4;
    pngCheckBox.checkBox.attachedToMainPanel = true;
    ...
    downloadButton.button.panel = 4;
    downloadButton.button.attachedToMainPanel = true;
    ...
    jpgIcon.icon.panel = 4;
    jpgIcon.icon.attachedToMainPanel = true;
    jpgIcon.type = "icon";
    ...
    pngIcon.icon.panel = 4;
    pngIcon.icon.attachedToMainPanel = true;
    pngIcon.type = "icon";
    UIElements["pngIcon"] = pngIcon;
    uiIndex.push_back("pngIcon");//34

	UIElement sphereIcon;
    sphereIcon.icon.positionX = 0.1f;
    sphereIcon.icon.positionY = 0.6f;
    sphereIcon.icon.positionZ = 0.99f;
    sphereIcon.icon.width = 0.02f;
    ...
    sphereIcon.icon.icon = icons.Folder;
    sphereIcon.icon.panel = 1;
    sphereIcon.icon.attachedToMainPanel = true;
    sphereIcon.type = "icon";
    UIElements["sphereIcon"] = sphereIcon;
    uiIndex.push_back("sphereIcon");//35

	UIElement planeIcon;
    planeIcon.icon.positionX = 0.0f;
    planeIcon.icon.positionY = -0.1f;
    planeIcon.icon.positionZ = 0.99f;
    planeIcon.icon.width = 0.03f;
    planeIcon.icon.height = 0.04f;
    ...
    planeIcon.icon.panel = 1;
    planeIcon.icon.attachedToMainPanel = true;
	planeIcon.type = "icon";
