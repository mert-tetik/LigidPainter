...
struct ColorData //LigidPainter color palette
{
	...
	glm::vec3 rangeBarBack = glm::vec3(0.65f, 0.65f, 0.65f);
	glm::vec3 rangeBarFront = glm::vec3(0.95f, 0.95f, 0.95f);
	glm::vec3 rangeBarSlide = glm::vec3(0.95f, 0.95f, 0.95f);
	...
	glm::vec3 numericModifierArrowHoverColor = glm::vec3(0.95f, 0.95f, 0.95f);
...
public:
	...
	glm::vec3 colorRect(float position_x, float position_y,float value, unsigned int FBO,GLFWwindow* window,glm::mat4 projection);
