...
unsigned int Load::loadCubemap(std::vector<std::string> faces,unsigned int textureSlot)
{
	GlSet glset;
...
InitializedTextures Load::initTextures(const char* maskTexturePath){
	GlSet glset;
	Texture txtr;
