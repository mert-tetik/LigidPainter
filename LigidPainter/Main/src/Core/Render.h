...
public:
	...
	void renderModel(bool backfaceCulling, std::vector<float>& vertices,PBRShaderData &data,Model &model,bool renderDefault);
	...
	void renderTextures(unsigned int FBOScreen, std::vector<float>& vertices, bool exportImage, bool JPG, bool PNG, const char* exportPath,  int screenSizeX,  int screenSizeY,const char* exportFileName,bool reduceScreenPaintingQuality,OutShaderData outShaderData,Model &model,bool renderDefault);
	...
	void getDepthTexture(std::vector<float>& vertices, unsigned int FBOScreen,  int screenSizeX,  int screenSizeY,ScreenDepthShaderData screenDepthShaderData,Model &model,bool renderDefault);
