...
public:
	...
	void renderModel(bool backfaceCulling, std::vector<float>& vertices,PBRShaderData &data,Model &model,bool renderDefault,vector<unsigned int> &albedoTextures);
	...
	void getDepthTexture(std::vector<float>& vertices, unsigned int FBOScreen,  int screenSizeX,  int screenSizeY,ScreenDepthShaderData screenDepthShaderData,Model &model,bool renderDefault,vector<unsigned int> &albedoTextures);
