...
void Renderer::loadShaders(){
    ...
    shaders.skyboxBall =            Shader("LigidPainter/Resources/Shaders/aVert/3D_☺model.vert"          ,   "LigidPainter/Resources/Shaders/aFrag/SkyboxBall.frag"        ,nullptr    ,nullptr,   nullptr      );
