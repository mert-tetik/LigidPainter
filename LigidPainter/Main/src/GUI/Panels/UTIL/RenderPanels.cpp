...
void panels_render(Timer& timer)
{
    ...
    panel_layers_render(timer, doMouseTracking && !twoD_painting_mode);
    Debugger::block("GUI : Panels : Layers Panel"); // End

    Debugger::block("GUI : Panels : Displaying modes panel"); // Start
    panel_displaying_modes_render(timer, doMouseTracking && !twoD_painting_mode);
    ...
    if(twoD_painting_mode){
        ...
        panel_twoD_painting_render(timer, doMouseTracking);
    ...
    if(panel_displaying_modes.selectedElement == 1 || panel_displaying_modes.selectedElement == 2){
        ...
        panel_painting_modes_render(timer, doMouseTracking);
        ...
        button_painting_brush_render(timer, doMouseTracking);
        ...
        if(panel_painting_modes.selectedElement == 2){
            ...
            panel_smear_painting_properties_render(timer, doMouseTracking);
        ...
        if(panel_painting_modes.selectedElement == 4){
            ...
            button_painting_filter_mode_filter_render(timer, doMouseTracking);
