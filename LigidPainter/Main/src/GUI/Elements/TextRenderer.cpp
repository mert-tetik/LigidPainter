...
glm::vec4 TextRenderer::rndrTxt(Shader shader,std::string text,float x,float y,float z,float maxX,bool multipleLines,float scale,float mostLeft,int index,bool render,bool leftAlign){
	glm::vec4 data;
	data.w = 0.f;
...
glm::vec3 TextRenderer::renderText(Shader shader,std::string text,float x,float y,float z,float maxX,bool multipleLines,float scale,float mostLeft,bool leftAlign){
	return rndrTxt(shader,text,x,y,z,maxX,multipleLines,scale,mostLeft,0,true,leftAlign);
}
glm::vec3 TextRenderer::renderText(Shader shader,std::string text,float x,float y,float z,float maxX,bool multipleLines,float scale,float mostLeft,bool active,int &activeChar,int &activeChar2,Timer &timer,bool leftAlign){
