...
#ifndef LGDUICHECKBOX_HPP
#define LGDUICHECKBOX_HPP
...
public:
    ...
    void render(glm::vec2 videoScale,Mouse& mouse, Timer &timer,TextRenderer &textRenderer){
        ...
        resultScale = glm::vec2(min(resultScale.x,resultScale.y)); //Make it a square
        ...
        textRenderer.renderText(shader,text,resultTextPos .x ,resultPos.y,resultPos.z+0.02f,orgResultPos.x + orgResultScale.x,false,resultScaleText,resultTextPos.x-resultScale.x);
    }
};
#endif