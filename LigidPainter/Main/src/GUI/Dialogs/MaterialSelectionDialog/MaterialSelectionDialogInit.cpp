...
MaterialSelectionDialog::MaterialSelectionDialog(int){
                            ...
                            
                            {
                                Section(
                                    Element(Button()),
                                    {
                                        ...
                                        Element(Button(ELEMENT_STYLE_STYLIZED, glm::vec2(10, 2), "Edit The Active Material", Texture(), 10.f, false)), 
    ...
    this->displayingFBO = Framebuffer(Texture((char*)nullptr, 512, 512), GL_TEXTURE_2D, Renderbuffer(GL_DEPTH_COMPONENT16, GL_DEPTH_ATTACHMENT, glm::ivec2(512)), "material selection dialog - displaying");
