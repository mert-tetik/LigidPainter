                                        ...
                                        )
{
    ...
    materialDisplayer = Button(ELEMENT_STYLE_SOLID, glm::vec2(45,45), colorPalette, "Material"        , appTextures.greetingDialogImage, 0.f, false);
    
    //Init the texture modifier
    appMaterialModifiers.textureModifier = MaterialModifier(colorPalette, appTextures, TEXTURE_MATERIAL_MODIFIER);
    appMaterialModifiers.textureModifier.sections[0].header.button.clickState1 = true;

    //Init the dust modifier
    appMaterialModifiers.dustModifier = MaterialModifier(colorPalette, appTextures, DUST_MATERIAL_MODIFIER);
    
    //Init the asphalt modifier
    appMaterialModifiers.asphaltModifier = MaterialModifier(colorPalette, appTextures, ASPHALT_MATERIAL_MODIFIER);
    
    //Init the fabric modifier
    appMaterialModifiers.fabricModifier = MaterialModifier(colorPalette, appTextures, FABRIC_MATERIAL_MODIFIER);
    
    //Init the moss modifier
    appMaterialModifiers.mossModifier= MaterialModifier(colorPalette, appTextures, MOSS_MATERIAL_MODIFIER);
    
    //Init the rust modifier
    appMaterialModifiers.rustModifier = MaterialModifier(colorPalette, appTextures, RUST_MATERIAL_MODIFIER);
    
    //Init the skin modifier
    appMaterialModifiers.skinModifier = MaterialModifier(colorPalette, appTextures, SKIN_MATERIAL_MODIFIER);
    
    //Init the solid modifier
    appMaterialModifiers.solidModifier = MaterialModifier(colorPalette, appTextures, SOLID_MATERIAL_MODIFIER);
    
    //Init the wooden modifier
    appMaterialModifiers.woodenModifier = MaterialModifier(colorPalette, appTextures, WOODEN_MATERIAL_MODIFIER);
