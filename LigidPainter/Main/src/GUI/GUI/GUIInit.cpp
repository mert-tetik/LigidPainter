...
void UI::init
    ...
    paintingPanel.sections[2].elements[4].button.texture.proceduralProps.proceduralID = 24; //Solid white
    paintingPanel.sections[2].elements[4].button.texture.proceduralProps.proceduralnverted = 0;
    paintingPanel.sections[2].elements[4].button.texture.proceduralProps.proceduralScale = 1.f;
    paintingPanel.sections[2].elements[4].button.texture.title = "AutoGeneratedMask";
    
    paintingPanel.sections[3].elements[0].button.meshSelection = true;
