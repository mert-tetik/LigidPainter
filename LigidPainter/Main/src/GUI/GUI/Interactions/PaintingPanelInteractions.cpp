                            ...
                            )
{
    ...
    painter.brushProperties.sizeJitter = paintingPanel.sections[1].elements[4].rangeBar.value;
    painter.brushProperties.fade = paintingPanel.sections[1].elements[5].rangeBar.value;
    painter.brushProperties.sinWavePattern = paintingPanel.sections[1].elements[6].checkBox.clickState1;
    painter.brushProperties.scatter = paintingPanel.sections[1].elements[7].rangeBar.value;
    painter.brushProperties.brushTexture = paintingPanel.sections[1].elements[8].button.texture;
    painter.brushProperties.individualTexture = paintingPanel.sections[1].elements[10].checkBox.clickState1;
    painter.brushProperties.rotation = paintingPanel.sections[1].elements[11].rangeBar.value;
    painter.brushProperties.rotationJitter = paintingPanel.sections[1].elements[12].rangeBar.value;
    painter.brushProperties.alphaJitter = paintingPanel.sections[1].elements[13].rangeBar.value;
    ...
    if(paintingPanel.sections[1].elements[9].button.hover && *Mouse::LClick()){ //If pressed to remove the brush texture button from brush/more
        char whitePixel[] = { 127, 127, 127, 127 };
        paintingPanel.sections[1].elements[8].button.textureSelection = true;
        paintingPanel.sections[1].elements[8].button.texture = Texture(whitePixel, 1, 1, GL_NEAREST);
        paintingPanel.sections[1].elements[8].button.texture.proceduralProps.proceduralID = 24; //Solid white
        paintingPanel.sections[1].elements[8].button.texture.proceduralProps.proceduralnverted = 0;
        paintingPanel.sections[1].elements[8].button.texture.proceduralProps.proceduralScale = 1.f;
        paintingPanel.sections[1].elements[8].button.texture.title = "AutoGeneratedMask";        
    }
    
    if(paintingPanel.sections[1].elements[15].button.hover && *Mouse::LClick()){ //If pressed to export brush file button from brush/more
        Brush exportBrush
                        (    
