                        ...
                        )
{
    ...
    vectorPaintingModePropertyPanel.pos.x = paintingModesPanel.pos.x;
    vectorPaintingModePropertyPanel.pos.y = paintingModesPanel.pos.y + paintingModesPanel.scale.y + vectorPaintingModePropertyPanel.scale.y;
